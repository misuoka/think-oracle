...
class Connection
{
     ...
     */
    protected $queryStr = '';
    // protected $typeMap  = 'array'; // 查询数据类型
    // 返回或者影响记录数
    protected $numRows = 0;
    // 事务指令数
    ...
    // 字段属性大小写
    protected $attrCase = \PDO::CASE_NATURAL; // 默认数据库返回结果
    // 监听回调
     ...
     * @return void
     */
    protected function setBuilder(BaseBuilder $builder)
    {
    ...
    /**
     * 执行查询但只返回OCIStatement resource对象
     * @access public
     * @return OCIStatement|string
     */
     ...
     * @return string
     */
    public function getError($result = true, $printSql = true)
    {
